...
{
    public sealed class PrunedPackageReference : IEquatable<PrunedPackageReference>
    {
        public string Name { get; }

        public VersionRange VersionRange { get; }

        public PrunedPackageReference(
            string name,
        ...
        {
            return Equals(obj as PrunedPackageReference);
        }

        public bool Equals(PrunedPackageReference? other)
        {
            if (other == null)
            {
                return false;
